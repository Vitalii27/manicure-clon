...
jQuery(function ($) {
    ...
    var wpcf7Elm1 = document.getElementById('wpcf7-f161-o5');
    ...
    if (wpcf7Elm1) {
        wpcf7Elm1.addEventListener('wpcf7mailsent', function (event) {
            ...
            // alertError.showAlert('<i class="fa fa-info-circle" aria-hidden="true"></i> Ваше сообщение отправлено');
            console.log(wpcf7Elm1);
        }, false);
    }
    if (wpcf7Elm2) {
